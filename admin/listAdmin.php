...
$sql = "select id,username,email from cmet_admin limit {$offset},{$pageSize}";
		...
		<table class="table" cellspacing="0" cellpadding="0">
			...
			<tbody>
					...
					<td align="center"><input type="button" value="修改" class="btn"
						onclick="editAdmin(<?php echo $row['id'];?>)"><input type="button"
						value="删除" class="btn"
						onclick="delAdmin(<?php echo $row['id'];?>)"></td>
				</tr>
                            <?php $i++; endforeach;?>
